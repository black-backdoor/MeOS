window.onload = function() {
    function checkScreenSize() {
        ...
        if (window.innerWidth < minWidth || window.innerHeight < minHeight) {
            console.warn(`%c[Warning]%c Screen size is too small for content! min-width is ${minWidth}px; min-height is ${minHeight}px; currently: ${window.innerWidth}px x ${window.innerHeight}px;`, 'color: OrangeRed; font-weight: bold;', 'color: inherit;');
