    ...
    template() {
        return `
            ...
            <div class="menu" id="powerMenu">
                <button class="menu-item" id="lock" title=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M144 144v48H304V144c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192V144C80 64.5 144.5 0 224 0s144 64.5 144 144v48h16c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V256c0-35.3 28.7-64 64-64H80z"/></svg>Lock</button>
                <button class="menu-item" id="sleep" title="The PC stays on but uses low power. Apps stay open so\nwhen the PC wakes up, you're instantly back to where\nyou left off."><!-- ACPI S3 --><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M16.48 29.07a14.09 14.09 0 0 1-5.82-26.9A1 1 0 0 1 12 3.5a12.11 12.11 0 0 0 2.4 13.61 12.11 12.11 0 0 0 13.6 2.4 1 1 0 0 1 1.33 1.33 14.15 14.15 0 0 1-12.82 8.23zM9.25 5.33A13 13 0 0 0 8 6.42a12.12 12.12 0 0 0 0 17.12 11.94 11.94 0 0 0 8.52 3.53 12.1 12.1 0 0 0 8.57-3.56 13 13 0 0 0 1.09-1.26A14.14 14.14 0 0 1 13 18.53a14.14 14.14 0 0 1-3.75-13.2z" data-name="do not disturb"/></svg>Sleep</button>
                <button class="menu-item" id="hibernate" title="Turns off the PC but apps stay open. When the PC is\n turned on, you're back where you left off."><!-- ACPI S4 --><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"/></svg>Hibernate</button>
                <button class="menu-item" id="shutdown" title="Closes all apps and turns off the PC."><!-- ACPI S5 --><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V256c0 17.7 14.3 32 32 32s32-14.3 32-32V32zM143.5 120.6c13.6-11.3 15.4-31.5 4.1-45.1s-31.5-15.4-45.1-4.1C49.7 115.4 16 181.8 16 256c0 132.5 107.5 240 240 240s240-107.5 240-240c0-74.2-33.8-140.6-86.6-184.6c-13.6-11.3-33.8-9.4-45.1 4.1s-9.4 33.8 4.1 45.1c38.9 32.3 63.5 81 63.5 135.4c0 97.2-78.8 176-176 176s-176-78.8-176-176c0-54.4 24.7-103.1 63.5-135.4z"/></svg>Shutdown</button>
                <button class="menu-item" id="reboot" title="Closes all apps, turns off the PC and then turns it on\nagain."><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M48.5 224H40c-13.3 0-24-10.7-24-24V72c0-9.7 5.8-18.5 14.8-22.2s19.3-1.7 26.2 5.2L98.6 96.6c87.6-86.5 228.7-86.2 315.8 1c87.5 87.5 87.5 229.3 0 316.8s-229.3 87.5-316.8 0c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0c62.5 62.5 163.8 62.5 226.3 0s62.5-163.8 0-226.3c-62.2-62.2-162.7-62.5-225.3-1L185 183c6.9 6.9 8.9 17.2 5.2 26.2s-12.5 14.8-22.2 14.8H48.5z"/></svg>Reboot</button>
            </div>
        `;
    }
