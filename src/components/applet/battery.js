class BatteryApplet extends HTMLElement {
    ...
    updateBatteryStatus(battery) {
        ...
        const batteryIconText = this.shadowRoot.querySelector('svg .text');
        const batteryIconStyle = this.shadowRoot.querySelector('svg style');
        ...
        if (!charging) {
            batteryIconStyle.innerHTML += `.charging { display: none; }`;
        }
